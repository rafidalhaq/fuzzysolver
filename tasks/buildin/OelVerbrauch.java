...
public class OelVerbrauch extends FuzzyTask {
    ...
    private List<FuzzyPart> prepareLV_Temperature() {
        ...
        temp_kalt = new FuzzyPart("kalt", new float[]{-10.0f, 1.0f}, new float[]{10.0f, 0.0f});
        temp_normal = new FuzzyPart("normal", new float[]{-10f, 0f}, new float[]{10f, 1f}, new float[]{30f, 0f});
        temp_warm = new FuzzyPart("warm", new float[]{10f, 0f}, new float[]{30f, 1f});
...
////        temp_warm.setPoints(points_temp_warm);
    ...
    private List<FuzzyPart> prepareLV_Oelpreis() {
        ...
        preis_niedrig = new FuzzyPart("niedrig", new float[]{0.0f, 1.0f}, new float[]{12.0f, 0.0f});
        preis_mittel = new FuzzyPart("mittel", new float[]{4.0f, 0.0f}, new float[]{16.0f, 1.0f}, new float[]{28.0f, 0.0f});
        preis_hoch = new FuzzyPart("hoch", new float[]{20.0f, 0.0f}, new float[]{32.0f, 1.0f});
...
//        preis_hoch.setPoints(points_preis_hoch);
    ...
    private List<FuzzyPart> prepareLV_Oelverbrauch() {
        ...
        verbrauch_niedrig = new FuzzyPart("niedrig", new float[]{0.0f, 0.0f}, new float[]{25.0f, 1.0f}, new float[]{50.0f, 0.0f});
        verbrauch_mittel = new FuzzyPart("mittel", new float[]{25.0f, 0.0f}, new float[]{50.0f, 1.0f}, new float[]{75.0f, 0.0f});
        verbrauch_hoch = new FuzzyPart("hoch", new float[]{50.0f, 0.0f}, new float[]{75.0f, 1.0f});
...
//        verbrauch_hoch.setPoints(points_verbrauch_hoch);
    ...
    public float solve(Graphics g, float[] exactValues) {
        ...
        for (int i = 0; i < fuzzy_rules.size(); i++) {
            ...
            FuzzyPart part = new FuzzyPart("result_part"+i,new float[]{x[0],y_min},new float[]{x[1],y_max});
